...
public class Calculator extends JFrame {
 ...
 // textField1.getText().length() = quantidade do caracteres lidos do textField1 - 
                    
                     // String caracterTemp = textField1.getText().substring()
                     // achouNumero = false;
   //                  {
     //                   if (textField1.getText().substring(c,c).equals(numeros[n])) { // "substring = faz a leitura exata da posição na string"
                        // "equals e um comparador do lado direito e do lado esquerdo"
             ...
             //           break;
               ...
               //      } else {
                 //       String strTextField1 = textField1.getText();
                   //     strTextField1.replace(textField1.getText().substring(c,c),"");
