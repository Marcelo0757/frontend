/**
  * public: declaração que "exporta* e permite que a classe/metodo/váriavel seja importada/reutilizada em outras classes/objetos
 ...
 * {("abre"chave): serve para declarar o início de um bloco de códigos/ações
  ...
  */
  public class HelloWorld  { // Aqui é criada a classe HelloWorld}
    ...
    * ((abre parênteses): serve para declarar o início das declarações de parâmetros de método/função
    ...
    * "HelloWorld": texto (string) ue será "impresso" na tela
    * ; (ponto e vírgula): serve para encerrar uma linha de código
    */
    public static void main (String[] args) { // Aqui é criada a classe main
      System.out.println("Hollo World!!!");}// Aqui é "impressa" uma linha com o texto "Hello World"
